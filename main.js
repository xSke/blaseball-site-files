  ...
  [
    ...
    function (e, a, t) {
      ...
      var n,
        ...
        y = o.a.createContext({ games: void 0, leagues: void 0, temporal: void 0 });
      function g(e, a) {
        e.onmessage = function (e) {
          var t = JSON.parse(e.data).value,
            n = { games: t.games, leagues: t.leagues, temporal: t.temporal };
          a(n), v.dispatch(n);
        };
      }
      var A = function (e) {
        var a = e.children,
          t = Object(r.useState)({ games: void 0, leagues: void 0, temporal: void 0 }),
          n = Object(s.a)(t, 2),
          l = n[0],
          i = n[1];
        return (
            ...
            g(e, i),
              (e.onmessage = function (e) {
                var a = JSON.parse(e.data).value,
                  t = { games: a.games, leagues: a.leagues, temporal: a.temporal };
                i(t), v.dispatch(t);
              });
            setInterval(
              Object(E.a)(
                  ...
                  return h.a.wrap(function (a) {
                    for (;;)
                      switch ((a.prev = a.next)) {
                        case 0:
                          e.close(), g((e = new EventSource(p + "streamData")), i);
                        case 3:
                        case "end":
                          return a.stop();
                      }
      ...
      K.defaultProps = { dismissable: !0, style: H.GENERIC };
      var z,
        Z = K,
        X =
          (t(16),
            ...
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.prev = 0), (e.next = 3), fetch("".concat(X, "/database/globalEvents"));
                    case 3:
            ...
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.prev = 0), (e.next = 3), fetch("".concat(X, "/database/offseasonSetup"));
                    case 3:
                      return (a = e.sent), (e.next = 6), a.json();
                    case 6:
                      return (t = e.sent), e.abrupt("return", t);
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.prev = 0), (e.next = 3), fetch("".concat(X, "/database/offseasonRecap?season=").concat(a))
                      );
                    case 3:
            ...
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.prev = 0), (e.next = 3), fetch("".concat(X, "/database/bonusResults?ids=").concat(a));
                    case 3:
                      return (t = e.sent), (e.next = 6), t.json();
                    case 6:
                      return (n = e.sent), e.abrupt("return", n);
            ...
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.prev = 0), (e.next = 3), fetch("".concat(X, "/database/decreeResults?ids=").concat(a));
                    case 3:
                      return (t = e.sent), (e.next = 6), t.json();
                    case 6:
                      return (n = e.sent), e.abrupt("return", n);
            ...
            return h.a.wrap(
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.prev = 0), (e.next = 3), fetch("".concat(X, "/database/players?ids=").concat(a));
                    case 3:
                      return (t = e.sent), (e.next = 6), t.json();
                    case 6:
                      return (n = e.sent), e.abrupt("return", n);
      ...
      var ue = t(18),
        ...
        pe = function () {
          return <div className="LoadingSpinner">{100 * Math.random() < 99 ? <V.a /> : <J.W />}</div>;
        };
      t(99), t(42);
      function fe(e, a) {
        return 0.5 === e
      ...
      var be = function (e) {
          ...
          if (
            ...
            return <pe />;
          var R = Math.min(he.maxBetTiers[n.maxBetTier].amount, n.coins),
            L = function () {
          ...
          var G = function (e) {
            ...
            M = <span className="Bet-Outcome-Winnings">{fe(L(), b)}</span>,
            W = <div className="Bet-Outcome-Wrapper">Choose a team to bet on.</div>;
          return (
            A &&
              (W = (
                <div className="Bet-Outcome-Wrapper">
                  You'll have a {D} chance to win {M} coins.
                </div>
              )),
            (
              <Z {...Object.assign({}, e, { className: "Bet" })}>
                ...
                <de.a
                  ...
                  onSubmit={function (e) {
                    ...
                    if ((e.preventDefault(), b > R)) a("Max bet is ".concat(R, "!"), { appearance: "error" });
                      ...
                      _("/api/bet", JSON.stringify(r)).then(function (e) {
                        h(!1),
                ...
                >
                  <de.a.Label>Pick a team:</de.a.Label>
                  ...
                  <de.a.Group className={"Bet-Form-Amount ".concat(A ? "" : "is-hidden")} controlId="amount">
                    <de.a.Label>How much do you want to wager?</de.a.Label>
                    <div className="Bet-Form-Inputs-Amount">
                      <div className="Bet-Coin-Wrapper">
                        <J.vb className="Bet-Coin-Icon" />
                        {n.coins}
                      </div>
                      <de.a.Control type="number" value={b} onChange={C} />
                      <de.a.Control
                        type="range"
                        className="Bet-Range"
                        min={1}
                  ...
                  <div className="Bet-Submit-Wrapper">
                    {d ? (
                      ...
                      <U.a className="Bet-Submit" type="submit" variant="success" disabled={!A}>
                        Submit
                      </U.a>
                    )}
                  </div>
        ...
        ye = [
          ...
          { name: "Overcast", icon: <ve.a />, background: "#cfcfcf", color: "#737373" },
          { name: "Rainy", icon: <ve.f />, background: "#348e9e", color: "#0727a8" },
          { name: "Sandstorm", icon: <ve.g />, background: "#877652", color: "#e0dac3" },
          { name: "Snowy", icon: <ve.h />, background: "#68969e", color: "#ffffff" },
          { name: "Acidic", icon: <ve.d />, background: "#92ad58", color: "#235917" },
          ...
          { name: "Peanuts", icon: <J.W />, background: "#c4aa70", color: "#423822" },
          { name: "Birds", icon: <J.g />, background: "#45235e", color: "#8e5fad" },
          { name: "Feedback", icon: <J.S />, background: "#383838", color: "#ff007b" },
      ...
      function ge(e) {
        var a = e.type,
          t = ye[a].icon;
        return (
          <div className="WeatherIcon" style={{ color: Ae(a), background: Ne(a) }}>
            {t}
          </div>
        );
      }
      ...
      function Be(e) {
          ...
          E = (function (e) {
            ...
            return (
              <div className="GameWidget-StatusBar">
                ...
                {e.started ? <ge type={e.weather} /> : null}
              </div>
            );
          })(h),
          p = (function (e) {
            ...
            h.complete || !h.started ? (
              ...
              <div className="GameWidget-AtBat">
                <div className="GameWidget-PlayerLine">
                  ...
                  <div className="GameWidget-PlayerLineNameWrapper" style={{ background: W(b, 0.5) }}>
                    <u
                      background={C}
        ...
        if (h.started && s.isSignedIn) L = null;
          ...
          var P,
            G = d[l.id],
            M = (null === G || void 0 === G ? void 0 : G.length) || 0,
            F = M > 0 ? G[0] : void 0;
          void 0 !== F && (P = F.entityId === l.homeTeam ? l.homeTeamName : l.awayTeamName),
            (L = (
              <Y.a className="GameWidget-Button-Centered">
                {M > 0 ? (
                  <div className="GameWidget-UpcomingBet">
                    <J.vb /> {M > 0 ? "".concat(F.amount, " on ").concat(P) : "No active bets"}
                  </div>
                ) : s.coins ? (
                  ...
                  <U.a className="GameWidget-Button" variant="success" disabled={!0}>
        ...
        var x = null,
          j = null,
          H = d[l.id],
          V = ((null === H || void 0 === H ? void 0 : H.length) || 0) > 0 ? H[0] : void 0;
        if (h.started) {
          var q = void 0 !== V ? fe(V.odds, V.amount) : 0;
          (x =
            ...
            <o.a.Fragment>
              <div className="GameWidget-Upcoming-Info">
                ...
                <div className="GameWidget-Upcoming-InfoBody">
                  ...
                  <div className="GameWidget-Upcoming-Body">
                    <ve.b className="GameWidget-Upcoming-Icon" />
                    <div className="GameWidget-Upcoming-Label">WEATHER</div>
                    <div className="GameWidget-Upcoming-Weather">
                      <span className="GameWidget-Upcoming-WeatherLabel">{ye[h.weather].name}</span>
                      <ge type={h.weather} />
                    </div>
                  </div>
                </div>
      ...
      var Ce,
        ...
        Qe =
          ...
          function (e) {
            ...
            var y,
              ...
              T = (
                <Le.a target={a.current} show={h} placement="bottom">
                  {function (e) {
                    e.placement, e.scheduleUpdate, e.arrowProps, e.outOfBoundaries, e.show;
                    var a = Object(Re.a)(e, ["placement", "scheduleUpdate", "arrowProps", "outOfBoundaries", "show"]);
                    return (
                      <div
                        {...Object.assign({}, a, {
            ...
            return (
              b &&
                (T = (
                  <Le.a target={a.current} show={h} placement="top">
                    {function (e) {
                      e.placement, e.scheduleUpdate, e.arrowProps, e.outOfBoundaries, e.show;
                      var a = Object(Re.a)(e, ["placement", "scheduleUpdate", "arrowProps", "outOfBoundaries", "show"]);
                      return (
        ...
        Ge = function (e) {
          ...
          return (
            Object(r.useEffect)(function () {
              function e(e) {
                e.leagues && ((Ce = e.leagues), i(e.leagues));
              }
              return (
                v.subscribe(e),
                function () {
      ...
      var De = Ge,
        ...
        We = function () {
          var e = Object(r.useContext)(Q.context),
            ...
            n = (Object(r.useContext)(O.context), Object(r.useContext)(De.context)),
            l = (Object(c.f)(), Object(r.useState)(!1)),
            i = Object(s.a)(l, 2),
            m = i[0],
            d = i[1],
            p = Object(ue.useToasts)().addToast,
            ...
            y = Object(r.useRef)(Math.floor(Math.random() * b.length)),
            g = (
            ...
            N = (
              <div className="CoinOverlay-Content">
                <div className="CoinOverlay-Content-Body">{m ? b[y.current] : f[v.current]}</div>
              </div>
            ),
            T = null;
          if (null !== a.favoriteTeam) {
            ...
            if (w) {
              var S = String.fromCodePoint(Number(w.emoji)),
                B = encodeURIComponent("".concat(w.slogan || "", " ").concat(S, " #blaseball")),
                ...
                <div className="Peanut-Container">
                                      ...
                                      switch ((e.prev = e.next)) {
                                        case 0:
                                          ...
                                          return (
                                            ...
                                            (e.next = 7),
                                            _("/api/eatADangPeanut", JSON.stringify({ amount: o }))
                                              .then(
                                                Object(E.a)(
                                                  h.a.mark(function e() {
                                                    return h.a.wrap(function (e) {
                  ...
                  >
                    <span className="Peanut-Line">
                      <span className="Peanut-Icon">{m ? "" : <J.W />}</span> {a.peanuts}
                    </span>
                  </Qe>
        ...
        Fe = function () {
          return (
            <o.a.Fragment>
              <je isModal={!0} path="/signup">
                Signup
              </je>
              <je isModal={!0} path="/login">
                Login
              </je>
            </o.a.Fragment>
          );
      ...
      function xe(e) {
        ...
        Object(r.useEffect)(function () {
          ...
          return (
            ...
            function () {
              e.removeListener(g), document.removeEventListener("click", A, !1);
            }
          );
        }, []);
        var g = function (e) {
          ...
          A = function (e) {
            v.current && !v.current.contains(e.target) && c(!1), y.current && !y.current.contains(e.target) && b(!1);
          },
          N = [],
          T = [];
        N.push({ text: "League", path: "/", subpaths: ["/upcoming", "/standings", "/leaderboard", "/postseason"] }),
          t &&
            t.isSignedIn &&
            (x(a.sim, "WILD_CARDS") ||
              x(a.sim, "DOUBLE_JUMPS") ||
              (N.push({ text: "Shop", path: "/shop", locked: !t.unlockedShop }),
              T.push({ text: "Bulletin", path: "/bulletin" })),
            N.push({ text: "Election", path: "/offseason", locked: !t.unlockedElection })),
          t &&
            t.isSignedIn &&
            ((x(a.sim, "WILD_CARDS") || x(a.sim, "DOUBLE_JUMPS")) &&
              (N.push({ text: "Bulletin", path: "/bulletin" }),
              T.push({ text: "Shop", path: "/shop", locked: !t.unlockedShop })),
            T.push({ text: "Book", path: "/thebook" }),
            x(a.sim, "UNLOCKED_HALL") && T.push({ text: "The Hall", path: "/thehall", glow: !0 }));
        var w = function () {
            c(!i);
          },
          S = t.isFetching ? null : t.isSignedIn ? <We /> : <Fe />,
          I = (
            <Me.a in={f} timeout={350} classNames="Navigation-Animation" unmountOnExit={!0}>
              <div className="Navigation-Main">
                {N.map(function (e, a) {
                  return (
                    <je key={a} path={e.path} subpaths={e.subpaths}>
                ...
                <div className="Navigation-Dropdown">
                  ...
                  <Me.a in={i} timeout={350} classNames="Navigation-Animation" unmountOnExit={!0}>
                    <div className="Navigation-Dropdown-Content" style={i ? { display: "flex" } : {}}>
                      {i &&
                        T.map(function (e, a) {
                          return (
                            <je key={a} path={e.path} glow={e.glow}>
                              {e.text}
                            </je>
                          );
                        })}
        ...
        return (
          <nav className="Navigation" ref={y}>
            ...
            {d ? I : B}
            {d ? null : <div className="Navigation-User">{S}</div>}
          </nav>
        );
      }
      function je(e) {
      ...
      function Ye(e) {
        ...
        console.log(
          ...
          Ue.a.event({ category: "Sponsor Clicked", action: "".concat(e) });
      }
      function Je() {
        return (
          <div className="Advertisement-SiteHeader">
            ...
            <span className="Advertisement-SiteHeader-Callout">
              <a
                ...
                onClick={function () {
                  return Ye("HoloVista (MainPage/Title)");
                }}
                target="_blank"
              >
                HoloVista
      ...
      (void 0 ===
        ...
        Ue.a.initialize("UA-171524925-1");
      t(106);
      function Ve() {
        ...
        return (
          <o.a.Fragment>
            ...
            <div className="LeagueNavigation-Nav">
              <je path="/">Watch Live</je>
              <je path="/upcoming">Place Bets</je>
              <je path="/standings">Standings</je>
              <je path="/leaderboard">Idols</je>
            </div>
          </o.a.Fragment>
        );
      }
        ...
        return (
          <o.a.Fragment>
            ...
            <div className="LeagueNavigation-Nav">
              <je path="/">Watch Live</je>
              <je path="/upcoming">Place Bets</je>
              <je path="/postseason">Postseason</je>
              <je path="/standings">Standings</je>
              <je path="/leaderboard">Idols</je>
            </div>
          </o.a.Fragment>
      ...
      var $e = o.a.createContext([{ id: "", place: 0 }]),
        ea = function (e) {
          var a = e.children,
            t = Object(c.g)().pathname,
      ...
      function ta() {
        ...
        var b = 7 == (null === (e = f.sim) || void 0 === e ? void 0 : e.phase),
          ...
          y = u.length < 1 || void 0 === u ? <pe /> : <na info={u} playoffs={b} line={v} />;
        return <o.a.Fragment>{y}</o.a.Fragment>;
      }
      function na(e) {
        var a = [];
        if (void 0 === e.info || e.info.length < 1) return <pe />;
        for (var t = !1, n = !1, r = 0; r < e.info.length; r++) {
          ...
          t ||
            ...
            ((t = !0), (n = !0)),
            r < 0 || e.line,
            a.push(<ra info={e.info[r]} key={e.info[r].place} showIcons={e.line} monitor={t} />),
            (t = !1);
        }
        return (
          <o.a.Fragment>
        ...
        return void 0 !== e.info ? (
          <div className={"Leaderboard-Player-Wrapper" + (e.showIcons ? " Leaderboard-Player-Wrapper-WithIcon" : "")}>
            <div className="Leaderboard-Icon-Wrapper">
              {e.showIcons && [].includes(e.info.place) ? <J.S className="Leaderboard-Icon-Microphone" /> : null}
              {e.showIcons && e.monitor ? <J.D className="Leaderboard-Icon-Monitor" /> : null}
            </div>
            <u
              background={i}
            ...
            >
              <div className="Leaderboard-Player-Name-Container">
                ...
                <div className="Leaderboard-Player-Name">
                  {s.idol === (null === (n = e.info.player) || void 0 === n ? void 0 : n.id) ? <J.qb /> : ""}{" "}
              ...
              <div className="Leaderboard-Team-Container">
                ...
                >
                  <div className="Leaderboard-Team-Emoji">
                    {String.fromCodePoint(Number(void 0 !== e.info.team ? e.info.team.emoji : "0x2753"))}
                  </div>
                </div>
      ...
      function la() {
        ...
        if (a)
          for (var l = 0; l < t.subleagues.length; l++)
            n.push(<ia key={l} league={t} subleague={t.subleagues[l]} standings={e.standings} />);
        return void 0 !== t ? (
      ...
      function ia(e) {
        ...
        for (var t = [], n = 0; n < a.divisions.length; n++)
          t.push(<sa key={n} league={e.league} division={a.divisions[n]} standings={e.standings} />);
        return (
            ...
            void 0 === u || (void 0 !== u && u.length <= 0) ? (
              ...
              <div>
                <div className="DailySchedule-Countdown">
                  {c() === oa.Upcoming ? <_e dateString={F().toString()} /> : null}
                </div>
                {h}
              </div>
            ),
      ...
      function ha(e) {
        ...
        if (
          ...
          return (
            <div className="PlayoffSetup-Body">
              <div className="PlayoffSetup-MatchupGroup">{Ea(l.roundNumber, i)}</div>
            </div>
          );
        ...
        return (
          <div className="PlayoffSetup-Body">
            <div className="PlayoffSetup-MatchupGroup">{Ea(l.roundNumber, c)}</div>
            <div className="PlayoffSetup-MatchupGroup">{Ea(l.roundNumber, m)}</div>
          </div>
        );
      }
      function Ea(e, a) {
      ...
      var va = function (e) {
          ...
          var N,
            T = g() === fa.Live ? f.schedule : f.tomorrowSchedule,
            w = g() === fa.Live ? f.postseason.matchups : f.postseason.tomorrowMatchups,
            S =
              void 0 === T || (void 0 !== T && T.length <= 0) ? null : (
                <ul>
                  {null ===
                    ...
                    ? void 0
                    : a.map(function (e, a) {
                        return <ke key={a} data={e} matchups={w} />;
                      })}
                </ul>
              ),
            I =
              ...
              N = y ? (
                ...
                <div>
                  {null !== S ? (
                    <div>
                      <div className="DailySchedule-Countdown">
                        {g() === fa.Upcoming ? <_e dateString={F().toString()} /> : null}
                      </div>
                      <ul>{S}</ul>
                    </div>
                  ) : (
            ...
            return (
              <div>
                <div className="PlayoffsEnd">
                  ...
                  <_e dateString={t.sim.nextSeasonStart} />
                </div>
                <qe />
                {"/leaderboard" === a ? <ta /> : <la />}
              </div>
      ...
      var Na = function () {
          ...
          return (
            <header className="Header">
              ...
              {(null === n || void 0 === n ? void 0 : n.isSignedIn) && <Aa />}
            </header>
          );
        },
        Ta = (t(114), o.a.createContext([{ id: "", peanuts: 0, place: 0 }])),
        wa = function (e) {
          var a = e.children,
            t = Object(c.g)().pathname,
            n = Object(r.useState)([]),
      ...
      function Oa() {
        ...
        var e = Object(r.useContext)(Sa.context),
          a = Object(r.useState)([]),
          t = Object(s.a)(a, 2),
          n = t[0],
          l = t[1];
        ...
        var c = n.length < 1 || void 0 === n ? <pe /> : <Ia info={n} seasonEnd={!1} />;
        return (
      ...
      function Ia(e) {
        ...
        for (var n = 0; n < e.info.length; n++)
          e.seasonEnd
            ? n < 14
              ? a.push(<Ba info={e.info[n]} key={e.info[n].place} glow={!0} />)
              : t.push(<Ba info={e.info[n]} key={e.info[n].place} />)
            : a.push(<Ba info={e.info[n]} key={e.info[n].place} />);
        return e.seasonEnd ? (
          ...
          >
            <div className="HallOfFlame-Player-Name-Container">
              ...
              <div className="HallOfFlame-Player-Name">
                {i.idol === (null === (t = e.info.player) || void 0 === t ? void 0 : t.id) ? <J.qb /> : ""}{" "}
      ...
      function Ma(e) {
        var a = e.id,
          t = e.type,
          n = Pa.collection.find(function (e) {
            return e.id === a;
          });
        void 0 === n && (n = Da);
        var r = (function (e) {
        ...
        return (
          <div className="AttributeIcon">
            <Te.a
              ...
              overlay={
                <we.a id="tooltip" className="AttributeTooltip">
      ...
      function Wa(e) {
        for (var a = e / 0.2, t = Math.round(2 * a) / 2, n = Math.floor(t), r = Math.ceil(t), l = [], i = 0; i < n; i++)
          l.push(<La.b />);
        return n !== r && l.push(<La.c />), (<span>{l}</span>);
      }
      function Fa(e, a) {
        var t = (function (e, a) {
        ...
        return t > 0.8 ? (
          <span className="Team-Player-Vibe-Line Team-Player-Vibe-MostExcellent">
            <Qa.c className="Team-Player-Vibe-Line-Arrow" />
            <Qa.c className="Team-Player-Vibe-Line-Arrow" />
            <Qa.c className="Team-Player-Vibe-Line-Arrow" />
          </span>
        ) : t > 0.4 ? (
          ...
          <span className="Team-Player-Vibe-Line Team-Player-Vibe-Neutral">
            <Qa.a className="Team-Player-Vibe-Line-Arrow" />
          </span>
        ) : t > -0.4 ? (
          <span className="Team-Player-Vibe-Line Team-Player-Vibe-LessThanIdeal">
            <Qa.b className="Team-Player-Vibe-Line-Arrow" />
          </span>
        ) : t > -0.8 ? (
      ...
      var xa = function (e) {
          ...
          var A = d.lineup.map(function (e) {
              ...
              return (
                <u background={l} path={"/player/".concat(e.id)} className="Team-Player-Line">
                  ...
                  >
                    {f.idol === e.id ? <J.qb /> : ""} {null === e || void 0 === e ? void 0 : e.name}
                  </div>
                  <div className="Team-Player-Vibe">
                    {Fa(e, void 0 !== (null === (a = t.sim) || void 0 === a ? void 0 : a.day) ? t.sim.day : -1)}
                  </div>
                  ...
                  <div className="Team-Attributes">
                    <div className="AttributeBar">
                      {b.permAttr.map(function (e, a) {
                        return <Ma id={e} type={Ra.Permanent} key={a} />;
                      })}
                      {b.seasAttr.map(function (e, a) {
                        return <Ma id={e} type={Ra.Season} key={a} />;
                      })}
                      {b.weekAttr.map(function (e, a) {
                        return <Ma id={e} type={Ra.Weekly} key={a} />;
                      })}
                      {b.gameAttr.map(function (e, a) {
                        return <Ma id={e} type={Ra.Game} key={a} />;
                      })}
                    </div>
                  </div>
                </o.a.Fragment>
          ...
          return (
            ...
            (<Z {...Object.assign({}, e, { className: "Team" })}>{y}</Z>)
          );
        },
        ja = (t(117), o.a.createContext({ doc: void 0 })),
        Ha = function (e) {
          var a = e.children,
          ...
          return (
            ...
            (<ja.Provider value={l}>{a}</ja.Provider>)
          );
        };
      Ha.context = ja;
      var Ua = Ha;
      function Ya() {
        var e,
          ...
          d = m.user,
          p = m.setUser,
          f = Object(r.useContext)(De.context).teams.find(function (e) {
            return e.id === d.favoriteTeam;
          }),
          b = Object(r.useContext)(O.context),
          v = Object(r.useContext)(Ua.context),
          y = Object(r.useContext)(De.context),
          g = Object(c.g)();
        function A(e) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        (e.next = 5),
                        _(t.buyUrl, JSON.stringify(t.buyParams))
                          .then(
                            (function () {
                              var e = Object(E.a)(
          ...
          (e =
            void 0 === (null === v || void 0 === v ? void 0 : v.doc)
              ...
              ? (function (e, a, t, n, r, l) {
                  ...
                  var g = he.maxBetTiers[Math.min(e.maxBetTier, he.maxBetTiers.length - 1)],
                    A = he.maxBetTiers[e.maxBetTier + 1];
                  if (void 0 !== A) {
                    var N = g.amount,
                      T = he.maxBetTiers[e.maxBetTier + 1].amount;
                    m = {
                      id: 1,
                  ...
                  var S = he.teamWinCoinTiers[Math.min(e.dailyCoinsTier, he.teamWinCoinTiers.length - 1)],
                    O = he.teamWinCoinTiers[e.dailyCoinsTier + 1];
                  u =
                    void 0 !== O
                      ? {
                          id: 2,
                  ...
                  if (x(t, "UNLOCKED_PEANUTS") && r) {
                    if (
                      ((f = {
                        id: 6,
                        name: "Peanut".concat(y.alpha > 1 ? "s" : ""),
                        description:
                          y.alpha < 0
                            ? "Purchase ".concat(y.alpha, " peanuts")
                            : 0 == y.alpha
                            ? "Purchase zero peanuts."
                            : 1 == y.alpha
                            ? "Purchase a peanut."
                            : y.alpha <= 10
                            ? "Purchase a pack of ".concat(y.alpha, " peanuts.")
                            : "Purchase a bucket of ".concat(y.alpha, " peanuts."),
                        amount: y.alpha,
                        toast: "You receive "
                          .concat(y.alpha, ". You now have ")
                          .concat(e.peanuts + y.alpha, " Peanuts."),
                        available: !0,
                        ...
                        userUpdate: function () {
                          a(
                            Object(I.a)(
                              Object(I.a)({}, e),
                              {},
                              { peanuts: e.peanuts + y.alpha, coins: e.coins - y.alpha }
                            )
                          );
                        },
                      }),
                      y.beta > 0 || e.squirrels > 0)
                    ) {
                      ...
                      b =
                        e.squirrels < Math.min(y.beta, B.length - 1)
                          ? {
                              id: 7,
                  ...
                  var Q = he.idolStrikeoutsTiers[Math.min(e.relics.Idol_Strikeouts, he.idolStrikeoutsTiers.length - 1)],
                    P = he.idolStrikeoutsTiers[e.relics.Idol_Strikeouts + 1];
                  if (void 0 === e.relics.Idol_Strikeouts) {
                    var G = he.idolStrikeoutsTiers[0],
                      D = Object.create(e.relics);
                    D.Idol_Strikeouts = 0;
                    var M = "Adorn yourself. When your Idol strikes a batter out, you'll earn ".concat(
                        G.amount,
                        " coins."
                      ),
                      W = !0;
                    ("" != e.idol && null != e.idol) || ((M += " Go to a Player page to choose an Idol."), (W = !1)),
                      (E = {
                        id: 14,
                        name: "Strikeout Pendant",
                        description: M,
                        amount: G.price,
                        toast: "Coins per Idol strikeout is now ".concat(G.amount),
                        available: W,
                        buyUrl: "/api/buyRelic",
                        icon: <J.C />,
                        buyParams: { relicId: "Idol_Strikeouts" },
                        userUpdate: function () {
                          a(Object(I.a)(Object(I.a)({}, e), {}, { coins: e.coins - G.price, relics: D }));
                        },
                      });
                  } else if (void 0 !== P) {
                    var F = Q.amount,
                  ...
                  var V = he.idolShutoutsTiers[Math.min(e.relics.Idol_Shutouts, he.idolShutoutsTiers.length - 1)],
                    q = he.idolShutoutsTiers[e.relics.Idol_Shutouts + 1];
                  if (void 0 === e.relics.Idol_Shutouts) {
                    var K = he.idolShutoutsTiers[0],
                    ...
                    (ee.Idol_Shutouts = ee.Idol_Shutouts + 1),
                      (p = {
                        ...
                        buyParams: { relicId: "Idol_Shutouts" },
                        userUpdate: function () {
                          a(Object(I.a)(Object(I.a)({}, e), {}, { coins: e.coins - q.price, relics: ee }));
                        },
                      });
                  } else {
                    var ae = V.amount;
                  ...
                  var te = he.idolHomersTiers[Math.min(e.relics.Idol_Homers, he.idolHomersTiers.length - 1)],
                    ne = he.idolHomersTiers[e.relics.Idol_Homers + 1];
                  if (void 0 === e.relics.Idol_Homers) {
                    var re = he.idolHomersTiers[0],
                  ...
                  var de = he.idolHitsTiers[Math.min(e.relics.Idol_Hits, he.idolHitsTiers.length - 1)],
                    Ee = he.idolHitsTiers[e.relics.Idol_Hits + 1];
                  if (void 0 === e.relics.Idol_Hits) {
                    var pe = he.idolHitsTiers[0],
                    ...
                    ("" != e.idol && null != e.idol) || ((be += " Go to a Player page to choose an Idol."), (ve = !1)),
                      (d = {
                        ...
                        userUpdate: function () {
                          a(Object(I.a)(Object(I.a)({}, e), {}, { coins: e.coins - pe.price, relics: fe }));
                        },
                      });
                  } else if (void 0 !== Ee) {
                    var ye = de.amount,
                    ...
                    (Ae.Idol_Hits = Ae.Idol_Hits + 1),
                      (d = {
                        ...
                        buyParams: { relicId: "Idol_Hits" },
                        userUpdate: function () {
                          a(Object(I.a)(Object(I.a)({}, e), {}, { coins: e.coins - Ee.price, relics: Ae }));
                        },
                      });
                  } else {
                    var Ne = de.amount;
                    ...
                    return void 0 === e ? null : e.isSponsor ? (
                      ...
                      <div className="Shop-Item" key={a}>
                        ...
                        <div className="Shop-Item-Checkout">
                          <J.vb className="Shop-Item-Coins" />
                            ...
                            {l && l.purchaseItem && l.purchaseItem.id === e.id ? (
                              ...
                              (function (e) {
                                return !e.available || e.maxed ? (
                                  ...
                                  <u className="Shop-Item-Button Shop-Item-Modal" background={g} path={e.buyUrl}>
                                    {w(e)}
                                  </u>
                                ) : (
                                  <U.a
      ...
      var Ja = function (e) {
          ...
          y ||
            (T = (
              <U.a className="BatchBuy-Submit" type="submit" variant="success">
                Buy
              </U.a>
            ));
          var w = Math.floor(n.coins / N);
          return (
            <Z {...Object.assign({}, e, { className: "BatchBuy" })}>
                ...
                onSubmit={function (e) {
                  e.preventDefault(),
                    p > n.coins
                      ...
                      : (g(!0),
                        _("/api/buyVote", JSON.stringify({ amount: p }))
                          .then(function (e) {
                            e.status && 200 === e.status && e.ok
                              ? (l(Object(I.a)(Object(I.a)({}, n), {}, { votes: n.votes + p, coins: n.coins - p * N })),
              ...
              >
                <de.a.Group className="BatchBuy-Form-Amount" controlId="amount">
                  <de.a.Label>How many votes do you want to buy?</de.a.Label>
                  <div className="BatchBuy-Form-Inputs-Amount">
                    <div className="BatchBuy-Ticket-Wrapper">
                      <J.ub className="BatchBuy-Ticket-Icon" />
                      {n.votes}
                    </div>
                    <de.a.Control type="number" value={p} onChange={A} />
                    <de.a.Control
                      type="range"
        ...
        Va =
          ...
          function (e) {
                      ...
                      for (;;)
                        switch ((a.prev = a.next)) {
                          case 0:
                            return (
                              (a.next = 2),
                              _("/api/updateFavoriteTeam", JSON.stringify({ teamId: m })).then(function (e) {
                                e.status &&
                                  200 === e.status &&
                                  e.ok &&
            ...
            return (
              <Z {...Object.assign({}, e, { className: "Welcome" })}>
        ...
        Ka =
          ...
          function (e) {
            var a = Object(r.useContext)(Q.context).initUser,
              t = Object(c.f)(),
              n = Object(ue.useToasts)().addToast,
              l = Object(r.useState)(!1),
              i = Object(s.a)(l, 2),
              m = i[0],
              u = i[1],
            ...
            return (
              <div className={"".concat(E ? "" : "Auth-SignupWrapper")}>
                {!E && <Ca />}
                <Z {...Object.assign({}, e, { className: "Auth" })}>
                  ...
                  <form
                    onSubmit={function (e) {
                      ...
                      _("/auth/local", JSON.stringify(r)).then(function (e) {
                        u(!1),
                          e.ok && e.status && 200 === e.status
                  ...
                  <a className="Auth-SocialAuth" href={"auth/google?redirectUrl=".concat(h)}>
                    <div className="Auth-SocialAuth-Icon-Container">
                      <V.e className="Auth-SocialAuth-Icon" />
                    </div>
        ...
        za = (t(121), o.a.createContext({ blessings: [], decrees: [], decreesToPass: 0 })),
        Za = function (e) {
          var a = e.children,
      ...
      var $a = function () {
          return (
            <a href="/login">
              <U.a className="Blessings-Submit-Button">Login to Vote</U.a>
            </a>
          );
        },
        et = function () {
          return (
            <a href="/welcome">
              <U.a className="Blessings-Submit-Button">Pick a Favorite Team to Vote</U.a>
            </a>
          );
        },
        at = function () {
          return (
            <a href="/shop">
              <U.a className="Blessings-Submit-Button">Buy Another Vote</U.a>
            </a>
          );
        },
        tt = function (e) {
        ...
        ot = function () {
          var e = Object(r.useContext)(_a.context),
            ...
            d = <$a />;
          return (
            a.isFetching || !a.isSignedIn || a.favoriteTeam || (d = <et />),
            a.isFetching || !a.isSignedIn || a.votes || (d = <at />),
            !a.isFetching &&
              a.isSignedIn &&
              a.favoriteTeam &&
              a.votes &&
              (d = (
                ...
                >
                  <u background={m} path={"/vote/".concat(Xa.BONUS, "/").concat(l)}>
      ...
      var st = (
        ...
        ct = function (e) {
          var a = e.svgRef,
            ...
            n = it(e, ["svgRef", "title"]);
          return (
            <svg {...lt({ viewBox: "0 0 24 24", ref: a }, n)}>
      ...
      var Tt = (
        ...
        wt = function (e) {
          var a = e.svgRef,
            ...
            n = Nt(e, ["svgRef", "title"]);
          return (
            <svg {...At({ width: 24, height: 24, viewBox: "0 0 24 24", ref: a }, n)}>
              {t ? <title>{t}</title> : null}
              {Tt}
            </svg>
          );
      ...
      var Bt = (
        ...
        kt = function (e) {
          var a = e.svgRef,
            ...
            n = It(e, ["svgRef", "title"]);
          return (
            <svg {...Ot({ viewBox: "0 0 512 512", ref: a }, n)}>
              {t ? <title>{t}</title> : null}
              {Bt}
            </svg>
          );
      ...
      var Ht = function () {
          return (
            <a href="/login">
              <U.a className="Decrees-Submit-Button">Login to Vote</U.a>
            </a>
          );
        },
        Ut = function () {
          return (
            <a href="/welcome">
              <U.a className="Decrees-Submit-Button">Pick a Favorite Team to Vote</U.a>
            </a>
          );
        },
        Yt = function () {
          return (
            <m.b to={{ pathname: "/shop" }}>
              <U.a className="Decrees-Submit-Button">Buy Another Vote</U.a>
            </m.b>
          );
        },
        Jt = function (e) {
      ...
      function Vt(e) {
        return "forbidden_book" === e ? (
          ...
          <J.y className="Decrees-Option-Icon" />
        ) : "eat_the_rich" === e ? (
          ...
          <Qa.e className="Decrees-Option-Icon" />
        ) : "targeted_shame" === e ? (
          <J.lb className="Decrees-Option-Icon" />
        ) : "roster_shuffle" === e ? (
          <La.a className="Decrees-Option-Icon" />
        ) : "home_field_advantage" === e ? (
          <V.b className="Decrees-Option-Icon" />
        ) : "team_punish" === e ? (
          <J.xb className="Decrees-Option-Icon" />
        ) : "do_nothing" === e ? (
          <J.Z className="Decrees-Option-Icon" />
        ) : "confuse_good" === e ? (
          <J.ob className="Decrees-Option-Icon" />
        ) : "confuse_evil" === e ? (
          <J.nb className="Decrees-Option-Icon" />
        ) : "parallel_world" === e ? (
          <J.cb className="Decrees-Option-Icon" />
        ) : "diagonal_world" === e ? (
          <J.tb className="Decrees-Option-Icon" />
        ) : "high_filter" === e ? (
          ...
          <J.G className="Decrees-Option-Icon" />
        ) : "wild_cards" === e ? (
          <J.m className="Decrees-Option-Icon" />
        ) : "relief" === e ? (
          <J.gb className="Decrees-Option-Icon" />
        ) : "double_jumps" === e ? (
          <J.O className="Decrees-Option-Icon" />
        ) : "forecast_birds" === e ? (
          <J.g className="Decrees-Option-Icon" />
        ) : "forecast_peanuts" === e ? (
          <J.W className="Decrees-Option-Icon" />
        ) : "forecast_eclipse" === e ? (
          <ve.i className="Decrees-Option-Icon" />
        ) : "forecast_blooddrain" === e ? (
          <ve.f className="Decrees-Option-Icon" />
        ) : "forecast_reverb" === e ? (
      ...
      var qt = function (e) {
        ...
        Kt = function () {
          var e = Object(r.useContext)(_a.context),
            ...
            d = <Ht />;
          return (
            a.isFetching || !a.isSignedIn || a.favoriteTeam || (d = <Ut />),
            a.isFetching || !a.isSignedIn || a.votes || (d = <Yt />),
            !a.isFetching &&
              a.isSignedIn &&
              a.favoriteTeam &&
              a.votes &&
              (d = (
                ...
                >
                  <u background={m} path={"/vote/".concat(Wt.DECREE, "/").concat(l)}>
                    Submit Decree Vote
                  </u>
                </U.a>
              )),
      ...
      function zt() {
            ...
            h.a.mark(function a() {
              ...
              return h.a.wrap(function (a) {
                for (;;)
                  switch ((a.prev = a.next)) {
                    case 0:
                      return (a.next = 2), ne(null === (t = e.sim) || void 0 === t ? void 0 : t.season);
                    case 2:
                      ...
                      return (a.next = 9), oe(n.bonusResults);
                    case 9:
                      for (
                        i = a.sent,
                          r = [],
                    ...
                    case 13:
                      ...
                      return (a.next = 16), ie(n.decreeResults);
                    case 16:
                      o = a.sent;
                    case 17:
        ...
        var f = n.recap ? n.recap.totalDecreeVotes : 1,
                  ...
                  return (
                    <div className="Recap-Decree-Container">
                      ...
                      <div className="Recap-Decree-Content">
                        <div className="Recap-Decree-Icon">{Vt(e.decreeId)}</div>
          ...
          y = null === v && null === b ? <div className="Recap-Note">Nothing happened in this Election.</div> : null;
        return (
          <div className="Recap">
      ...
      function Zt() {
        ...
        return a && a.sim ? 0 === a.sim.phase ? <zt /> : e.unlockedElection ? <Xt /> : <$t /> : null;
      }
      function Xt() {
        var e,
          a = Object(r.useContext)(O.context),
        ...
        return (
          <div className="Offseason">
            <div className="Offseason-Info">
              ...
              <_e dateString={null === (e = a.sim) || void 0 === e ? void 0 : e.nextElectionEnd} />
            </div>
            <div className="Offseason-Body">
              <_a value={{ blessings: [], decrees: [], decreesToPass: 0 }}>
                <_t />
              </_a>
            </div>
          </div>
      ...
      var en = function (e) {
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 9:
                          return (
                            g(!0),
                            (e.next = 12),
                            _("/api/payTribute", JSON.stringify({ playerId: m, amount: p }))
                              .then(
                                (function () {
                                  var e = Object(E.a)(
                                    h.a.mark(function e(t) {
                                          ...
                                          switch ((e.prev = e.next)) {
                                            ...
                                            case 2:
                                              t.ok && t.status && 200 === t.status
                                                ? (l(Object(I.a)(Object(I.a)({}, n), {}, { peanuts: n.peanuts - p })),
                                                  a(
          ...
          return (
            y ||
              (T = (
                <U.a className="Tribute-Submit" type="submit" variant="success">
                  Pay Tribute
                </U.a>
              )),
            (
              <Z {...Object.assign({}, e, { className: "Tribute" })}>
                <div className="Tribute-Header">Pay Tribute</div>
                <de.a className="Tribute-Form" onSubmit={N}>
                  <de.a.Group className="Tribute-Form-Amount" controlId="amount">
                    <de.a.Label>How many peanuts will you offer?</de.a.Label>
                    <div className="Tribute-Form-Inputs-Amount">
                      <div className="Tribute-Ticket-Wrapper">
                        <J.W className="Tribute-Ticket-Icon" />
                        {n.peanuts}
                      </div>
                      <de.a.Control type="number" value={p} onChange={A} />
                      <de.a.Control
        ...
        an =
          ...
          function (e) {
            ...
            return (
              A ||
                (O = (
                  <U.a className="Vote-Submit" type="submit" variant="success">
                    Submit
                  </U.a>
                )),
              (
                <Z {...Object.assign({}, e, { className: "Vote" })}>
                  ...
                  >
                    <de.a.Group className="Vote-Form-Amount" controlId="amount">
                      ...
                      <div className="Vote-Form-Inputs-Amount">
                        <div className="Vote-Ticket-Wrapper">
                          <J.ub className="Vote-Ticket-Icon" />
                          {n.votes}
                        </div>
                        <de.a.Control type="number" value={b} onChange={w} />
                        <de.a.Control
                          type="range"
        ...
        return (
          <div>
            <div className="GodsDay">
              ...
              <_e dateString={null === (a = l.sim) || void 0 === a ? void 0 : a.nextSeasonStart} />
            </div>
            <qe />
            {"/leaderboard" === t ? <ta /> : <la />}
          </div>
      ...
      var sn = <image id="Ball" x={87} y={75} width={784} height={911} xlinkHref="<img/png blob>" />,
        cn = function (e) {
          var a = e.svgRef,
            t = e.title,
            n = ln(e, ["svgRef", "title"]);
          return (
            <svg {...on({ width: 959, height: 1065, viewBox: "0 0 959 1065", ref: a }, n)}>
              {t ? <title>{t}</title> : null}
              {sn}
            </svg>
          );
        },
        mn = o.a.forwardRef(function (e, a) {
          return <cn {...on({ svgRef: a }, e)} />;
        });
      t.p, t(130), t(131), t(132);
      function un(e) {
      ...
      var dn = function (e) {
              ...
              <un
                element={
                  <div className="Stubs-All">
                    ...
                    <_e dateString={null === (a = n.sim) || void 0 === a ? void 0 : a.nextPhaseTime} />
        ...
        fn = function (e) {
                        ...
                        case 0:
                          return (
                            fetch("/api/getUserNotifications", { credentials: "include" })
                              ...
                              .then(function (e) {
                                e && u([].concat(Object(hn.a)(m), Object(hn.a)(e.notes)));
                              })
                              .catch(function (e) {
                                u([]);
                              }),
          ...
          Object(r.useEffect)(
            function () {
              y() && (void 0 !== f.current && clearTimeout(f.current), (f.current = setTimeout(A, 5e3))),
                (p.current = N);
            },
            [N]
          );
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.next = 4),
                            _("/api/clearUserNotifications", JSON.stringify({ noteIds: a }))
                          );
                        case 4:
                        case "end":
                          return e.stop();
          ...
          return <pn.Provider value={T}>{a}</pn.Provider>;
        };
      fn.context = pn;
      var bn = fn;
      t(133);
        ...
        return (
          <div className="TheBook-All">
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              a. Each season of Blaseball shall last 99 games. In the case of <yn str="the Ultimate ||||||||" />,
              seasons shall <yn str="|||||||||||||||||, or at least until the ||||||| have ||||||||." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              b. Every day of Blaseball shall last one <yn str="|||||" /> hour.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. If any games last longer than one <yn str="|||||" /> hour, a Spillover shall occur, and all games shall
              be delayed until the next <yn str="|||||" /> hour. In the case of a game lasting two <yn str="|||||" />{" "}
              hours, the{" "}
              <yn str="entire season should be ||||||||| and both teams should be ||||||||| ||||||||| |||||||| |||| for |||||| |||||||||||." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              ...
              <yn str="|||||" /> hour shall be skipped, and then the Round shall begin at the top of the next available{" "}
              <yn str="|||||" /> hour.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              ...
              <yn str="||||| shall be ||||||||, and both teams shall be |||||||||| |||||||| ||||||||||||." />
            </div>
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              ...
              Blaseball.{" "}
              <yn str="The content of such Votes shall be ||||||||||||||| ||||||||||||||||||| ||||||||| entertainment" />
              .
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              <span>b. Decrees will be decided by popular vote.</span>
              <yn str="It is understood that ||||||||||||||||| will be a ||||||||||| |||||||||||, and the others shall ||||||||||||||| ||||||||||||||| ||||||||| |||||||||||||." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. Blessings will be decided by a raffle. <yn str="It is understood that each of these" /> should give
              players <yn str="||||||||||||| |||||||||||" /> control of the league. All won Blessings shall be processed
              & applied in order of the standings.{" "}
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. <yn str="||||||||||||||||||" /> may occur at the end of an Election, before Decrees and Blessings are
              processed. <yn str="Anything can happen here" />. Good luck.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              a. Teams are a <yn str="|||||||||| || players" /> bound by <yn str="| |||||| |||||||||| |||| ||||||" />.
              Names, colors, icons, and slogans are{" "}
              <yn str="||||||||||| |||||||||||| || ||| |||| |||||| || ||||| |||||||||||||" /> in order for the Fans{" "}
              <yn str="to find them palatable." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              b. A Team's roster is built of four sections: Lineup, Rotation, <yn str="Bench" />, and{" "}
              <yn str="Bullpen" />. The Lineup and Rotation make up a Team's Active Roster, and the <yn str="Bench" />{" "}
              and <yn str="Bullpen" /> make up a Team's Shadows. A Team's Shadows cannot be accessed unless directly
              specified, or through direct selection from a public interface.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. Teams may choose <yn str="|| |||| ||||| ||||| || ||||||||, a |||||| |||||" /> to contain and represent
              their <yn str="||||||" />. The Fans may shape <yn str="|||| |||||| as they" /> uncover and decipher{" "}
              <yn str="their ||||' ||||||." />
            </div>
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              b. Each game should take place <yn str="at the home team's stadium" /> on the immaterial plane.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. Weather: <yn str="The home team's stadium should determine the weather." /> In the case that{" "}
              <yn str="||||||||||||||||||||" />, a Solar Eclipse shall last until <yn str="||||||||||||||||||||" />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              d. There are <yn str="two positions" /> in Blaseball, <yn str="||||||||||||||||||||." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              e. When a team is on Defense,{" "}
              <yn str="all of the team's ||||||| will stand ||||||||| out in the field. Doesn't really matter where." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              f. The pitcher must throw the ball <yn str="with their hands." />, unless{" "}
              <yn str="that doesn't make sense." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              g. Once the ball is in play,{" "}
              <yn str="||| |||| || ||| |||||||||| ||||| |||||||||| the outcome of the play. ||| |||| ||||||| || ||||||||||||||||" />{" "}
              immaterial plane{" "}
              <yn str="|||||||||||||| ||||||| ||||||| ||||||||| ||||||||||||||| |||||||||||||||| |||||||| |||||||| unfathomable." />
            </div>
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              k. Crying in Blaseball is <yn str="||||||||||." />
            </div>
            <div className="TheBook-Line TheBook-Bullet">
              6. <yn str="The Gods" /> and You
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              a. Should the Participants open the Forbidden Book,{" "}
              <yn str="The Discipline Era should begin||||||||||||||||||||||" /> suffering{" "}
              <yn str="upon the league. Players shall be " /> banished{" "}
              <yn str="at the ||||||||||| ||||||||| |||| ||||||||||||||||." /> The Discipline Era shall last until{" "}
              <yn str="the Participants have" /> atoned.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              b. If a team wins three championships, they, and Blaseball, shall ascend.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. When teams are sent to <yn str="||||||||||| |||||||||||||" />, they shall return once{" "}
              <yn str="|||||||||||||||| |||||||||||||||||||||| |||||||||||||" />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              d. Divine Favor: the <yn str="||||" /> have an internal ranking of favored teams. The list is decided{" "}
              <yn str="|||||||||" /> each season, and determines all standings tiebreakers.
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              e.{" "}
              <del>
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              f. Sunglasses{" "}
              <yn str="shall be |||||||||| ||||||||||||| |||||||||||||||||. They shall provide |||||||||||||| may be ||||||||||||||||||||." />
            </div>
            ...
            <div className="TheBook-Line TheBook-SubBullet">
              a. It is known{" "}
              <yn str="that the intention of the game of Blaseball |||||||||||||||||||||||| |||||||||||||||||||| |||||||||||||| |||||||||||||||||| ||||||||||| |||||||||| would be diminished." />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              b. <yn str="|||||||" />: Several entities in the <yn str="||||||||||||||" /> shall be chosen{" "}
              <yn str="||||||||||" /> to bring Blaseball to the people{" "}
              <yn str="|||||||||||||||||| ||||||||||||||||||" />
            </div>
            <div className="TheBook-Line TheBook-SubBullet">
              c. It is known that the majority of the icons on the site are sourced from{" "}
              <a href="https://game-icons.net">Game-Icons.net</a>. <yn str="||||||||" /> thank the authors immensely.
              Individual author credits coming soon.
            </div>
            <div className="TheBook-Line TheBook-Bullet">Signed,</div>
            <div className="TheBook-Line TheBook-SubBullet">
              <yn str="||||" />,  <yn str="||||" />,  <yn str="||||||||" />,  <yn str="|||||||" />,  
              <yn str="||||||||" />,  <yn str="|||||||||" />,  <yn str="|||||||" />,  <yn str="||||" />,  
              <yn str="||||||" />,  H
              <yn str="||||||||||" />,  <yn str="||||||" />,  <yn str="|||||||" />,  <yn str="||||| ||||" />,  A
              <yn str="|||||| ||||||" />,  <yn str="||||" />,  N
              <yn str="||||||" />,  <yn str="||" />,  <yn str="||||||" />,  M
              <yn str="|| ||||||" />
            </div>
          </div>
        );
      ...
      function gn() {
        var e,
          a = Object(r.useContext)(Ua.context),
          ...
          (m =
            0 !== u.sim.phase ? (
              <o.a.Fragment>
                ...
                <div className="Bulletin-Item-Contents">
                  <div className="Bulletin-Item-Contents-Text">
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT{" "}
                    <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb /> EMERGENCY ALERT <J.jb />
                  </div>
                </div>
              </o.a.Fragment>
            ) : (
      ...
      function wn() {
        return <Qa.f className="Bulletin-Bullet" />;
      }
      var Sn, On;
      t(136);
      !(function (e) {
      ...
      var Bn = function (e) {
          ...
          function k(e) {
            for (var a = 0; a < m.teams.length; a++) {
              for (var t = m.teams[a], n = 0; n < t.lineup.length; n++) if (t.lineup[n] === e.id) return t;
              for (var r = 0; r < t.rotation.length; r++) if (t.rotation[r] === e.id) return t;
              for (var o = 0; o < t.bench.length; o++) if (t.bench[o] === e.id) return t;
                ...
                <div className="Player-Status">
                  ...
                  {w ? (
                    ...
                    <u
                      ...
                      background={P}
                      path={"/tribute/".concat(null === f || void 0 === f ? void 0 : f.player.id)}
                    >
                      <J.W /> Pay Tribute
                    </u>
                  )}
              ...
              (f.player.permAttr.length > 0 ||
                ...
                <div className="Player-Attributes">
                  <div className="AttributeBar">
                    ...
                    {"NONE" !== R ? <Ma id={R} type={Ra.Item} /> : null}
                    {"NONE" !== L ? <Ma id={L} type={Ra.Armor} /> : null}
                  </div>
                </div>
              ) : null,
            W = (function () {
                ...
                h.a.mark(function e(a) {
                  return h.a.wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if ((a.preventDefault(), !f || !f.player || f.player.id === g.idol)) {
                            e.next = 10;
                            break;
                          }
                          if (!(g.coins < 200) || ("" === g.idol && null === g.idol)) {
                            e.next = 6;
                            break;
                          }
                        ...
                        case 6:
                          return (
                            ...
                            _(
                              "/api/chooseIdol",
                              JSON.stringify({ playerId: f.player.id, playerName: f.player.name })
                            ).then(
                              (function () {
                                var e = Object(E.a)(
                                  h.a.mark(function e(a) {
                                    return h.a.wrap(function (e) {
                                      for (;;)
                                        switch ((e.prev = e.next)) {
                                          case 0:
                                            a.ok && a.status && 200 === a.status && f && f.player
                                              ? (!1,
                                                "" === g.idol || null === g.idol
                                                  ? (A(Object(I.a)(Object(I.a)({}, g), {}, { idol: f.player.id })), !0)
                                                  : g.coins >= 200 &&
                                                    (A(
                                                      Object(I.a)(
                                                        Object(I.a)({}, g),
                                                        {},
                                                        { coins: g.coins - 200, idol: f.player.id }
                                                      )
                                                    ),
                                                    !0),
                                                v(f.player.name + " is now your idol.", { appearance: "success" }))
          ...
          var j = (function (e, a) {
              ...
              var t =
                ...
                n = M.collection.find(function (a) {
                  return a.id === e.bat;
                }),
                r = M.collection.find(function (a) {
                  return a.id === e.armor;
                });
                ...
                <o.a.Fragment>
                  <div className="Player-Info">
                    <div className="Player-Header">
                      <div className="Player-Header-Name">{f.player.name}</div>
                      <div className="Player-Header-Bottom">
                        <div className="Player-Team-Line">
                          <div
                            className="Player-Team-Logo"
                            style={{ background: void 0 !== f.team ? f.team.mainColor : "#999999" }}
                          >
                            <div className="Player-Team-Emoji">
                              {String.fromCodePoint(Number(void 0 !== f.team ? f.team.emoji : "0x2753"))}
                            </div>
                          </div>
                          <div className="Player-Team-Name">{void 0 !== f.team ? f.team.fullName : "Null Team"}</div>
                        </div>
                            ...
                            {(F || j) && H !== f.player.id ? (
                              <div className="Idol-Disabled-Tooltip">
                                <Te.a
                                  placement="right"
                                  overlay={
                                    <we.a id="tooltip-disabled" className="Idol-Disabled-Tooltip">
                                      {F
                              ...
                              <de.a className="Player-Button-Form" onSubmit={W}>
                  ...
                  <div className="Player-Content">
                    <ul className="Player-Info-Stats">
                      <div className="Player-Info-Line">
                        ...
                        {(function (e, a) {
                          ...
                          if (t > 0.8)
                            return (
                              <span className="Player-VibeLine Player-Vibe-MostExcellent">
                                <Qa.c className="Player-VibeLine-Arrow" />
                                <Qa.c className="Player-VibeLine-Arrow" />
                                <Qa.c className="Player-VibeLine-Arrow" />
                          ...
                          if (t > -0.1)
                            return (
                              <span className="Player-VibeLine Player-Vibe-Neutral">
                                <Qa.a className="Player-VibeLine-Arrow" />
                          ...
                          if (t > -0.4)
                            return (
                              <span className="Player-VibeLine Player-Vibe-LessThanIdeal">
                                <Qa.b className="Player-VibeLine-Arrow" />
                          ...
                          f.player,
                          void 0 !== (null === (n = i.sim) || void 0 === n ? void 0 : n.day) ? i.sim.day : -1
                        )}
                      </div>
                      <div className="Player-Info-Line">
                    ...
                    <ul className="Player-Info-Bio">
                      ...
                      <div className="Player-Info-Line">
                        ...
                        <div className="Player-Info-Line-Body">{f.player.ritual}</div>
                      </div>
                      <div className="Player-Info-Line">
                        ...
                        <div className="Player-Info-Line-Body">
                          {(function (e) {
                            switch (e) {
                              case On.Black:
                                return "Black";
                              case On.LightAndSweet:
                                return "Light & Sweet";
                              case On.Macchiato:
                                return "Macchiato";
                              case On.CreamAndSugar:
                                return "Cream & Sugar";
                              case On.ColdBrew:
                                return "Cold Brew";
                              case On.FlatWhite:
                              ...
                              case On.Decaf:
                                return "Decaf";
                              case On.MilkSubstitute:
                                return "Milk Substitute";
                              case On.PlentyOfSugar:
                      ...
                      <div className="Player-Info-Line">
                        ...
                        <div className="Player-Info-Line-Body">{f.player.fate}</div>
                      </div>
                      <div className="Player-Info-Line">
          ...
          return <Z {...Object.assign({}, e, { className: "Player" })}>{V}</Z>;
        },
        kn =
          (t(137),
          function (e) {
      ...
      function Qn() {
        ...
        return (
          ...
          void 0 !== e && e.isFetching ? <Gn /> : a && a.doc && a.doc.epsilon ? <Dn /> : l ? <Mn /> : <Pn />
        );
      }
      function Pn() {
        var e = Object(c.g)(),
        ...
        return (
          <div>
            ...
            <div className="Main-Body-Intro">
              ...
              {a && (
                <o.a.Fragment>
                  <c.a path="/signup" children={<Ka isModal={!0} />} />
                  <c.a path="/login" children={<Ka isModal={!0} isLogin={!0} />} />
                  <c.a path="/team/:nickname" children={<xa isModal={!0} />} />
                  <c.a path="/bet/:gameId" children={<be isModal={!0} />} />
                  <c.a path="/vote/:voteType/:entityId" children={<an isModal={!0} />} />
                  <c.a path="/tribute/:entityId" children={<en isModal={!0} />} />
                  <c.a path="/buy/:itemName" children={<Ja isModal={!0} />} />
                </o.a.Fragment>
              )}
              <qa isModal={!0} dismissable={!1} />
            </div>
            <footer className="Main-Footer">
              ...
              <div className="Main-Footer-Advertise">
                <div className="Main-Footer-Advertise-Inner">
                  <a className="Main-Footer-Advertise-Icon" href={Wn()}>
                    Become a Sponsor
                  </a>
                </div>
              </div>
      ...
      var xn = { sim: void 0, standings: void 0, season: void 0 };
